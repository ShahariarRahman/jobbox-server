...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.1f8vol0.mongodb.net/?retryWrites=true&w=majority`;
...
app.get("/", (req, res) => {
  res.send("Welcome to Job Box Server");
});
